...
const begin = function( cb, reviver ) {
...
const _parser = [Object.freeze( begin() )];
let _parse_level = 0;
const parse = function( msg, reviver ) {
	//var parser = JSON6.begin();
	const parse_level = _parse_level++;
	if( _parser.length <= parse_level )
		_parser.push( Object.freeze( begin() ) );
